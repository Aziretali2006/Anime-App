...
submit.addEventListener("click", (event) => {
  ...
  if(names.value !== "" && clan.value !== "" && level.value !== "" && power.value !== "" && village.value !== "" && image.value !=="") {
    const data = {
      name:names.value,
      clan:clan.value,
      level:level.value,
    ...
    const add = JSON.parse(localStorage.getItem("ninjas"))

    localStorage.setItem("ninjas",
      JSON.stringify(
        [
          ...add,
          data
